...
\begin{document}
	...
	\end{Def}
	Before going on we would like to define yet another important concept: the transition functions.
	\begin{Def}
	...
	\end{Def}
	\begin{Ex}
		CURVATURA TENSORIALE DI TIPO AD
	\end{Ex}
	...
	\section{Gauge transformations on the associated bundle}
	In this section we will look at the natural action of gauge transformations on an associated bundle of a principal bundle. More indormations on thuis topic can be found in [3] chap. 5. pag. 265-278.
	\begin{Prop}

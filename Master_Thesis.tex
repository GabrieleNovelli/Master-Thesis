...
\begin{document}
	...
	\begin{proof}
		...
		Let $\omega\in\Omega_\rho^k(P,V)$, $x\in M$, $p\in P_x$, $v_i\in T_xM$ and $u_i$ such that $d\pi(u_i)=v_i$. Then:
		$$\omega^{\flat\sharp}$$
	...
	\begin{proof}
		...
		$$\sigma=\tau\circ \pi|_U:P|_U\rightarrow U\rightarrow G$$
		The action of this map has the following property:
		$$\sigma\circ r_g=\tau\circ \pi|_U\circ r_g$$
	\end{proof}
